...
// Declaring a variable of type String
    ...
    private Connection()
    {
         try {
            ...
            if (con != null) {
                String createTable = "CREATE TABLE IF NOT EXISTS users (id INT NOT NULL AUTO_INCREMENT , name VARCHAR(255) NOT NULL , class VARCHAR(255) NOT NULL , rollno VARCHAR(255) NOT NULL , dob VARCHAR(255), PRIMARY KEY (id))";
